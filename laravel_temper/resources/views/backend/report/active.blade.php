 <?php
	...
	$breadcrumb[1]['title'] = 'Report Active Employee';
    $breadcrumb[1]['url'] = url('backend/avtive-employee-report');
?>
...
<!-- TITLE -->
@section('title', 'Avtive Employee Report')

<!-- CONTENT -->
@section('content')
	<div class="page-title">
		<div class="title_left">
			<h3>Active Employee Temperature</h3>
		</div>
...
@section('script')
	...
	<script>
		...
		$('.dataTable').dataTable({
			processing: true,
			serverSide: true,
			ajax: "<?=url('backend/active-employee-report/datatable?location='.$location.'&startDate='.$startDate.'&endDate='.$endDate.'&mode='.$mode);?>",
			columns: [
